...
const errorHandelr = (data: any, status: number) => {
    log({level: 'error', message: `axios failed ${status}: ${data}`, file: '/services/init', service: 'initialize'});
}
